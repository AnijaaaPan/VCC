...
export default class VcAutoCreateService extends Service<VcAutoCreate> {
  constructor(protected guildId: string) {
    super(guildId, 'vcAutoCreates')
  }
